        ...
        <header className="bg-white p-4 shadow-sm border-b border-slate-100">
          <div className="mx-auto max-w-4xl flex justify-between items-center">
            ...
            <Image src={profilePic} alt="Logo" width={100} height={100} />
              ...
              <a href="/recipes/new" className="hover:text-blue-600 text-black">Submit a Recipe</a>
              <a href="/recipes/submitted" className="hover:text-blue-600 text-black">Submitted Recipes</a>
